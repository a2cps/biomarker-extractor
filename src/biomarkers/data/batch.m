%-----------------------------------------------------------------------
% Job saved on 26-Sep-2024 16:34:28 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
% matlabbatch{1}.spm.tools.cat.estwrite.opts.tpm = {'/home/psadil/matlab/toolbox/spm12/tpm/TPM.nii'};
...
% matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.WMHtpm = {'/home/psadil/matlab/toolbox/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/cat_wmh_miccai2017.nii'};
% matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.BVtpm = {'/home/psadil/matlab/toolbox/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/cat_bloodvessels.nii'};
% matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.SLtpm = {'/home/psadil/matlab/toolbox/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/cat_strokelesions_ATLAS303.nii'};
% matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.regmethod.shooting.shootingtpm = {'/home/psadil/matlab/toolbox/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_0_GS.nii'};
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.admin.verb = 3;
